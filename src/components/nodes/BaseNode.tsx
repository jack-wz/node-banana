  ...
  return (
    <div
      className={hasExpandedSettings
        ...
        // down the settings.
        ? `relative flex flex-col w-full h-full overflow-visible bg-[#2B2B2F] rounded-2xl ${
            selected
              ? "ring-2 ring-inset ring-white/[0.64]"
              : running
    ...
    >
      ...
      <div
        className={`
          ...
          ${!fullBleed && selected && settingsExpanded && !running ? "border-white/[0.64]" : ""}
          ${className}
        `}
        data-tutorial={!hasExpandedSettings ? dataTutorial : undefined}
        onMouseEnter={(e) => {
