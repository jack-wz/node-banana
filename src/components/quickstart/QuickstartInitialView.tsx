      ...
      <div className="flex gap-10">
        ...
        <div className="flex-1 flex flex-col gap-2 justify-end">
          <OptionButton
            ...
            title={t("qs.newProject")}
            description={t("qs.newProjectDesc")}
          />
          ...
          <OptionButton
            ...
            title={t("qs.loadWorkflow")}
            description={t("qs.loadWorkflowDesc")}
          />
          ...
          <OptionButton
            ...
            title={t("qs.templates")}
            description={t("qs.templatesDesc")}
          />
          ...
          <OptionButton
            ...
            title={t("qs.promptWorkflow")}
            description={t("qs.promptWorkflowDesc")}
            badge="Beta"
          />
